...
<div class="wrapper row4">
  <footer id="footer" class="clear"> 
    <div class="one_third first">
      ...
      <article>
      	<p><a href="../news/news_find.do">더보기</a></p>
      </article>
    </div>
    <div class="one_third">
...
<div class="wrapper row5">
  <div id="copyright" class="clear"> 
    <p class="fl_left">Copyright &copy; 2023 - 강남 쌍용 교육센터 - <a href="#">3강의실</a></p>
    <p class="fl_right">제작<a target="_blank" href="https://www.os-templates.com/" title="Free Website Templates">차서녕</a></p>
  </div>
</div>
</body>
</html>