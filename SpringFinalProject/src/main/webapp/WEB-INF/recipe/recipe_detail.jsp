  ...
  <main class="container clear">
  	<div class="one_half first">
  		<c:if test="${count==0 }">
  			<table class=table>
  			  <tr>
  			  	<td class=text-center><h3>등록된 레시피가 없습니다</h3></td>
  			  </tr>
  			</table>
  		</c:if>
  		<c:if test="${count>0 }">
  			<table class=table>
  			  ...
  			  <tr>
  			  	<td class=text-center><img src="../images/info1.png" style="height:25px"></td>
  			  	<td class=text-center><img src="../images/info2.png" style="height:25px"></td>
  			  	<td class=text-center><img src="../images/info3.png" style="height:25px"></td>
  			  </tr>
  			  <tr>
