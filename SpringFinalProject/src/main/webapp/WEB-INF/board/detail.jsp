    ...
    <table class="table">
  	  ...
  	  <tr>
  	  	<td colspan=4 class=text-right>
  	  		<a :href="'../board/update.do?no='+board_detail.no" class="btn btn-sm btn-primary">수정</a>
  	  		<a :href="'../board/delete.do?no='+board_detail.no" class="btn btn-sm btn-warning">삭제</a>
  	  		<input type=button value="목록" class="btn btn-sm btn-success" onclick="javascript:history.back()">
  	  	</td>
  	  </tr>
  	</table>
  </main>
